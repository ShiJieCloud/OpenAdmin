...
class OperLogCreateRequest(BaseModel):
    ...
    terminal_type: str | None = Field(None, description="终端类型", max_length=32)
    ip_country: str | None = Field(None, description="国家/地区", max_length=32)
    ip_province: str | None = Field(None, description="省份/州", max_length=32)
    ip_city: str | None = Field(None, description="城市/镇", max_length=32)
    ip_location: str | None = Field(None, description="IP归属地", max_length=128)
...
class OperLogResponse(BaseModel):
    ...
    terminal_type: str | None = Field(None, description="终端类型")
